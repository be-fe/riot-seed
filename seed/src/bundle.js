...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riotSeedRouter = __webpack_require__(4);

	var _riotSeedRouter2 = _interopRequireDefault(_riotSeedRouter);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _riotSeedRouter2.default)({
	    'app': [{ route: '/main', tag: 'app-main', default: true }, { route: '/somebody', tag: 'app-somebody' }]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module) {var riot = __webpack_require__(1);
	(function(global, riot) {
	    ...
	    if ("function" === 'function' && typeof module === 'object' && module && typeof exports === 'object' && exports) {
	        ...
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function() { return (global.riotRouter = riotRouter) }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	    else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riotSeedFlux = __webpack_require__(7);

	var _riotSeedFlux2 = _interopRequireDefault(_riotSeedFlux);
	...
	riot.tag2('app-main', '<h1>hello {page.name}</h1> <a href="#/somebody">goto hello somebody</a>', '', '', function (opts) {
	    var self = this;
	    _riotSeedFlux2.default.bind.call(self, {
	        store: _store2.default.page,
	        name: 'page'
	    });

	    _store2.default.page.setName('world');
	});
	riot.tag2('app-somebody', '<h1>hello {page.name}</h1> <a href="#/main">goto hello world</a>', '', '', function (opts) {
	    ...
	    _store2.default.page.setName('somebody');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(global, riot) {
	    ...
	    if ("function" === 'function' && typeof module === 'object' && module && typeof exports === 'object' && exports) {
	        ...
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function() { return (global.flux = flux) }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    }
	    else {
	        global.flux = flux;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = {};
	store.page = _riotSeedFlux2.default.createStore({
	    get: function get() {
	        this.data = {
	            name: 'world'
	        };
